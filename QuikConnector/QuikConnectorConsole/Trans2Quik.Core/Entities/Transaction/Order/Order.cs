...
namespace Trans2Quik.Core.Entities.Transaction.Order
{
    public class Order
    {
        ...
        /// <summary>
        /// Для фьючерса на Si цена, например, 56000, если просто отправлять в quik, 
        /// будет ошибка формата, цена не должна содержать decimals, т.к Price.ToString() отдаст 56000.00
        /// </summary>
        ...
        internal Order SetOrderTradeParams(OrderTradeParams orderTradeParams)
        {
            ...
            this.SupportDecimals = orderTradeParams.SupportDecimals;
        ...
        public override string ToString()
        {
            ...
            var price = (SupportDecimals == false && Price.HasValue) ? Math.Round(Price.Value, 0).ToString() : Price.ToString();

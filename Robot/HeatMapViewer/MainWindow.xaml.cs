...
using DistributionViewer.HeatMapProviders;
...
namespace DistributionViewer
{
    public partial class MainWindow
    {
        ...
        public bool ShowLables => BtnShowLables.IsChecked.HasValue && BtnShowLables.IsChecked.Value;
        ...
        {
            if (_candles.Any() == false) return;

            var heatMap = new TimeToDayHeatMapProvider(_candles).Get();

            HeatMapChart.Init(heatMap);
            HeatMapChart.Draw();
        }        
        ...
        private void ShowLables_OnClick(object sender, RoutedEventArgs e)
        {
            HeatMapChart.ShowLables = ShowLables;

...
namespace UnitTestProject1
{
    ...
    public class LogScaleDetrendedChangesValuatorTests
    {
        ...
        public void TestMethod1()
        {
            ...
            data.Add(new Candle() { Date = DateTime.Now, Open = 1, Close = 2 });
            data.Add(new Candle() { Date = DateTime.Now, Open = 2, Close = 4 });
            data.Add(new Candle() { Date = DateTime.Now, Open = 4, Close = 8 });

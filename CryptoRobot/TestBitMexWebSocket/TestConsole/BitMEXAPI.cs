...
namespace BitMEX
{
    ...
    public class BitMEXApi
    {
        ...
        private long GetNonce()
        {
            ...
            return new DateTime(2018, 6, 5, 15, 0, 0).Ticks - yearBegin.Ticks;
        }
        ...
        private string Query(string method, string function, Dictionary<string, string> param = null, bool auth = false, bool json = false)
        {
            ...
            if (auth)
            {
                //long unixTime = (long)(DateTime.Now.AddSeconds(30) - new DateTime(1970, 1, 1)).TotalSeconds;
                //string apiExpires = unixTime.ToString();
                //string apiExpires = DateTime.UtcNow.AddHours(2).ToString();
                ...
                //webRequest.Headers.Add("api-expires", nonce);
        ...
        public string PostOrders()
        {
            ...
            return Query("POST", "/order", param, true, true);
        }
